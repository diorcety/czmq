...
{
    zlist_sort ((zlist_t *) (intptr_t) self, (zlist_compare_fn *) (intptr_t) compare);
}
...
{
    zlist_comparefn ((zlist_t *) (intptr_t) self, (zlist_compare_fn *) (intptr_t) fn);
}

JNIEXPORT jlong JNICALL
Java_org_zeromq_czmq_Zlist__1_1freefn (JNIEnv *env, jclass c, jlong self, jlong item, jlong fn, jboolean at_tail)
{
    jlong freefn_ = (jlong) (intptr_t) zlist_freefn ((zlist_t *) (intptr_t) self, (void *) (intptr_t) item, (zlist_free_fn *) (intptr_t) fn, (bool) at_tail);
    return freefn_;
}
